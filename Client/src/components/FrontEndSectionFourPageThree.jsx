...
function FrontEndSectionFourPageThree(props) {
			...
			<Grid container className={classes.toggleCanvasWrapper}>
				<Grid item xs={12} md={2} container className={classes.sideHeaderWrapper}>
					<Typography varian="h3">
						Report &amp; Customisation - Create content your prospects identify with and display professionalism through design
					</Typography>
				</Grid>
...
export default withStyles(styles)(FrontEndSectionFourPageThree);
